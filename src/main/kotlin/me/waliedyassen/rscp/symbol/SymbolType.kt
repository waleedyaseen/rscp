...
open class SymbolType<T : Symbol>(
    ...
    object VarOrVarbit : PrimitiveSymbolType(-1, '\u0000', "varorvarbit")
    object EntityOverlay : PrimitiveSymbolType(-1, '-', "entityoverlay")
    object StringVector : PrimitiveSymbolType(-1, '¸', "stringvector")
