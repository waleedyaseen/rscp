...
class Compiler(var extractMode: ExtractMode, val graphicsDirectory: File) {
    ...
    /**
     * Clear all of the stored symbols in the symbols table.
     */
    fun clearSymbols() {
        sym.clear()
    }
    ...
    /**
     * Clear all of the stored information for this round of compilation.
     */
    fun clearRound() {
        semanticInfo.clear()
        diagnostics.clear()
     ...
     * to the disk.
     */
    fun generateCode(generators: List<CodeGenerator>, directory: File, side: Side) {
